...
REQUIRED_STRUCTURE = {
    ...
    "thesis/h_matrix_diagnostics/figures/h_singular_value_maps.png": "file",
    "thesis/h_matrix_diagnostics/figures/otf_magnitude_grid_selected_masks.png": "file",
    "thesis/h_matrix_diagnostics/figures/mask_frequency_diversity_cv_map.png": "file",
    "thesis/h_matrix_diagnostics/figures/wavelength_transfer_comparison.png": "file",
