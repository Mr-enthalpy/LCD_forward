...
Conclusion for the clean `complex128` setting: `alpha=3e-15` is the best tested value by mean multi-frame raw PSNR and mean PSNR gain across the three CAVE scenes.
